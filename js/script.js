								...
								$('#data-list').append(`
									...
									<div class="row mt-3 justify-content-center">								
										<table border=0 width=100% >
											...
											<tr><td><b>Foto Selfie :</td></tr><tr><td style='padding-left:35px';><b><font size=2> <input type=file name=file accept='image/*' capture='camera' id='but_take' required></td></tr>
